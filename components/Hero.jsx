    ...
    <section className="bg-[#0F0F0F] relative overflow-hidden">
      <div className="max-w-3xl mx-auto px-6 pt-28 pb-24 md:pt-36 md:pb-32 lg:pt-44 lg:pb-40 text-center">
        ...
        <button
          ...
          className="bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-semibold text-lg px-14 py-5 rounded-full transition-all duration-300 cursor-pointer shadow-[0_4px_24px_rgba(37,99,235,0.35)] hover:shadow-[0_6px_32px_rgba(37,99,235,0.45)] hover:scale-[1.03] mb-5"
        >
          무료 보장 진단 받기
        </button>

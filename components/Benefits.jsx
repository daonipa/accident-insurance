        ...
        <div className="grid md:grid-cols-2 gap-6">
          {benefits.map((item, i) => (
            <ScrollAnimation key={i} delay={i * 100}>
              <div className="bg-white rounded-2xl p-8 border border-[#D5D5D5] shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.1)] hover:border-[#BBBBBB] transition-all duration-300">

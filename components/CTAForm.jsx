...
export default function CTAForm({ source = "accident-insurance" }) {
    ...
    return (
      <section id="cta-form" className="py-28 md:py-36 bg-dark">
        <div className="max-w-md mx-auto px-6 text-center">
          <div className="bg-white rounded-2xl p-10 shadow-[0_8px_32px_rgba(0,0,0,0.25)]">
            <div className="w-14 h-14 rounded-full bg-[#059669] mx-auto mb-6 flex items-center justify-center shadow-[0_4px_12px_rgba(5,150,105,0.3)]">
    ...
    <section id="cta-form" className="py-28 md:py-36 bg-dark">
      <div className="max-w-md mx-auto px-6">
        ...
        <ScrollAnimation delay={150}>
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.25)] space-y-5">
            <div>
                ...
                {CALL_TIMES.map((time) => (
                  <button
                    ...
                    className={`py-3 px-4 rounded-xl text-sm font-medium border transition-all duration-200 cursor-pointer ${
                      form.callTime === time
                        ? "border-primary bg-primary-light text-primary shadow-[0_0_0_1px_rgba(37,99,235,0.3)]"
                        : "border-[#D5D5D5] text-body hover:border-[#AAAAAA] hover:shadow-[0_1px_4px_rgba(0,0,0,0.06)]"
                    }`}
                  >
                    {time}
                  </button>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-primary-dark disabled:opacity-50 text-white font-semibold text-base py-4 rounded-xl transition-all duration-300 cursor-pointer shadow-[0_2px_12px_rgba(37,99,235,0.25)] hover:shadow-[0_4px_20px_rgba(37,99,235,0.35)]"
            >
              {isSubmitting ? (
